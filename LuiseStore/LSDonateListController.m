...
@implementation LSDonateListController
...
{
	[[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=opa334@protonmail.com&item_name=LuiseStore"] options:@{} completionHandler:^(BOOL success){}];
}
